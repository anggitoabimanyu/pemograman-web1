...
<div class="container ">
      <div class="row mb-3 mt-3">
        <div class="col-md-12">
        <a href="input_inf.php" class="btn btn-success">Input Artikel</a>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
    ...
    ?>
            <tr>
              ...
              <td>
                <a href="edit_inf.php?id=<?php echo $row["id"] ?>" class="btn btn-success"><i class="fa fa-pen"></i></a>
                <a href="delete_inf.php?id=<?php echo $row["id"]?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
